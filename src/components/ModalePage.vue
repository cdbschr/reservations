...
<template>
  ...
  >
    <div class="flex items-center justify-center min-h-screen">
      ...
      >
        <div
          class="flex flex-col h-full justify-between bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4"
        >
          <button class="self-end" @click="close">
            <svg
          ...
          <div
            class="mt-5 mb-10 text-center sm:mt-0 sm:ml-4 sm:text-left flex-grow flex items-center justify-center"
          >
            <slot></slot>
          </div>
        </div>
